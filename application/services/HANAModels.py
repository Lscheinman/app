...
class HANAModel():
    ...
    def initialize_CONDIS_Customization(self):
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'AC2', 'ActionToSupport');'''
        self.curCondis.execute(sql)  
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'BA1', 'BasedAt');'''
        self.curCondis.execute(sql)        
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'CL1', 'CloseColleagueWith');'''
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'CL2', 'ColleagueWith');'''
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'CL3', 'CloseFriendsWith');'''
        self.curCondis.execute(sql)  
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'EM1', 'EmployedAt');'''
        self.curCondis.execute(sql)        
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'HA3', 'HasSibling');'''
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'HA4', 'HasParent');'''
        self.curCondis.execute(sql)        
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'HA5', 'HasChild');'''
        self.curCondis.execute(sql)    
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'HA6', 'HasRole');'''
        self.curCondis.execute(sql)          
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'IN3', 'IncludesTerm');'''
        self.curCondis.execute(sql)         
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'LI2', 'Likes');'''
        self.curCondis.execute(sql)        
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'LO1', 'LocatedAt');'''
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'MA1', 'MarriedTo');'''
        self.curCondis.execute(sql)        
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'OP1', 'OppositeCause');'''
        self.curCondis.execute(sql)        
        ...
        self.curCondis.execute(sql)   
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'RE6', 'ResultedIn');'''
        self.curCondis.execute(sql)          
        ...
        self.curCondis.execute(sql)
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'UP1', 'UpdatedBy');'''
        self.curCondis.execute(sql)        
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'WI1', 'Witnessed');'''
        self.curCondis.execute(sql)        
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'WO1', 'WorksAt');'''
        self.curCondis.execute(sql) 
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'WO2', 'WorksFor');'''
        self.curCondis.execute(sql)     
        sql = '''INSERT INTO "CONDIS_SCHEMA"."com.sap.condis::content.TT_RELATION" VALUES ('en', 'WO3', 'WorksWith');'''
        self.curCondis.execute(sql)      
    ...
    def ConDisRelTypeCode(self, TYPE):
        ...
        if TYPE == 'AccountCreated' or TYPE == 'AccountCreation':
            ...
            rmap = 'CA3'
        elif TYPE == 'CanceledBy':
            rmap = 'CA4'
        elif TYPE == 'ChargedWith':
            rmap = 'CH1'
        elif TYPE == 'CloseColleagueWith':
            rmap = 'CL1'
        elif TYPE == 'ColleagueWith':
            rmap = 'CL2'
        elif TYPE == 'CloseFriendsWith':
            rmap = 'CL3'            
            ...
            rmap = 'OW1'   
        elif TYPE == 'OppositeCause':
            rmap = 'OP1'        
        elif TYPE == 'PartOf':
            rmap = 'PA1'    
        elif TYPE == 'PhotoOf':
            rmap = 'PH1'        
        elif TYPE == 'ProcessedIntel':
            rmap = 'PR1'
        elif TYPE == 'Published':
            rmap = 'PU1'
        elif TYPE == 'PublishedIntel':
            rmap = 'PU2'
        elif TYPE == 'PublishedTask':
            rmap = 'PU3'
        elif TYPE == 'ReportedAt':
            rmap = 'RE1'
            ...
            rmap = 'TA2'
        elif TYPE == 'TAReference':
            rmap = 'TA3'
        elif TYPE == 'TextAnalytics':
            rmap = 'TA4'
